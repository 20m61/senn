...
| Browser e2e | `pnpm --filter @senn/web e2e` (Playwright Chromium; RTCPeerConnection handoff + text + tampered URL + add-on echo round-trip + add-on storage persist/reload + namespace) |
